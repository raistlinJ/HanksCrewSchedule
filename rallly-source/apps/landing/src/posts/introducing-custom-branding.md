...
For Pro users, that branding extends to every touchpoint guests see:

- Your **space icon** appears on the poll event card
- Your **custom primary color** is applied to the invite page
- Confirmation emails participants receive after voting include your logo and colors

It's a small change visually, but it makes a real difference when the person on the other end sees something that actually looks like it belongs to you.
...
![Branding settings panel](https://d39ixtfgglw55o.cloudfront.net/images/branding-settings.webp)
